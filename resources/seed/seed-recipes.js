...
export default [{
  ...
  'name': 'Chocolate Chip Cookies'
    ...
    'ingredients': [
      ...
      {unitQuantity: 1, unit: UNITLESS, name: 'chopped nuts'},
  ...
  //  'author': 'neallred',
  //  'ingredients': [
  //    '9 c. rice krispie squares (rice chex)',
  //    '1/2 c. peanut butter',
  //    '1 c. chocolate chip',
  ...
  //  'author': 'samashby',
  //  'ingredients': [
  //    '1 1/4 c. flour (white, wheat, or both)',
  //    '3/4 c. oat bran',
  //    '1/3 c. brown sugar',
  //    '1 Tbsp. baking powder',
  //    '1 tsp. cinnamon',
  ...
  //  'author': 'violet2flame',
  //  'ingredients': [
  //    '18 oz. triple chocolate cookie dough',
  ...
  //  'author': 'samashby',
  //  'ingredients': [
  //    '6 medium chicken breasts, skinned',
  //    '1/4 c. flour',
  //    '1/2 tsp. salt',
  //    '1/2 tsp. paprika',
  //    '1/8-1/4 tsp. pepper',
  ...
  //  'author': 'samashby',
  //  'ingredients': [
  //    '18 oz. tray of Pasta Prima Grilled Chicken and Mozzarella Ravioli',
  //    '3/4 c. olive oil',
  ...
  //  'author': 'violet2flame',
  //  'ingredients': [
  //    "2 c. boiling water', '5 tsp. baking soda', '5 c. all-purpose flour', '1 quart buttermilk', '4 c. bran cereal (such as Kellogg''s All-Bran)', '2 c. bran flakes cereal', '1 c. chopped walnuts', '1 c. white sugar', '1/2 c. vegetable oil', '1/2 c. butter, melted', '4 eggs, beaten', '2 tsp. ground cinnamon', '1 tsp. salt', '1/2 tsp. ground ginger', '1/2 tsp. nutmeg"
  //  ],
  ...
  //  'author': 'pauladeen',
  //  'ingredients': [
  //    '6 (1 oz.) bittersweet chocolate squares',
  ...
  //  'author': 'samashby',
  //  'ingredients': [
  //    '2 c. sliced rhubarb in 1 inch pieces',
  //    '2 Tbsp. water',
  //    '1 c. sugar',
  //    '2 Tbsp. butter',
  //    '1/3 c. flour',
  ...
  //  'author': 'samashby',
  //  'ingredients': [
  //    '1 4-serving size package of orange gelatin',
  //    '1 c. boiling water',
